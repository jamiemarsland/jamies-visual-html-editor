...
/**
 * Whether an element has text of its own, i.e. a non-whitespace text node as a
 * direct child rather than inside a nested element.
 */
...
function decorateText( container ) {
	container
		...
		.forEach( ( element ) => {
			...
			// text directly (e.g. <div class="price">$49</div>).
